...
rc.exe /nologo /fo build\Qahse.res src\Qahse.rc
if errorlevel 1 (
...
cl.exe /EHsc /std:c++17 /Zc:__cplusplus /O2 /Ob2 /Ot /Oi /GL /Gy /MP /W3 /sdl /permissive- /openmp /arch:AVX /FS /utf-8 /bigobj /Zm999 /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS /DEIGEN_USE_MKL_ALL /nologo ^
  ...
  /Fe"build\Qahse.exe" /Fobuild\ /Fdbuild\ ^
  @sources.rsp ^
  ...
  mkl_intel_lp64_dll.lib mkl_intel_thread_dll.lib mkl_core_dll.lib libiomp5md.lib ChronoEngine.lib build\Qahse.res
